...
contract Game is Ownable {
    ...
    // @audit - should use better naming for storage variables such as `s_pendingWinnings`.
    ...
    // @audit - should use better naming for storage variables such as `s_playerClaimCount`.
